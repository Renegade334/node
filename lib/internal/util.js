...
const {
  getArrayBufferViewBuffer: _getArrayBufferViewBuffer,
  getArrayBufferViewByteLength: _getArrayBufferViewByteLength,
  getArrayBufferViewByteOffset: _getArrayBufferViewByteOffset,
...
function getArrayBufferViewBuffer(buffer) {
  validateBuffer ??= require('internal/validators').validateBuffer;
  validateBuffer(buffer);
  return _getArrayBufferViewBuffer(buffer);
}

function getArrayBufferViewByteLength(buffer) {
  validateBuffer ??= require('internal/validators').validateBuffer;
  validateBuffer(buffer);
  return _getArrayBufferViewByteLength(buffer);
}

function getArrayBufferViewByteOffset(buffer) {
  validateBuffer ??= require('internal/validators').validateBuffer;
  validateBuffer(buffer);
  return _getArrayBufferViewByteOffset(buffer);
}
