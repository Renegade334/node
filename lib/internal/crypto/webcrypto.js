...
async function encrypt(algorithm, key, data) {
  ...
  algorithm = normalizeAlgorithm(algorithm, 'encrypt');
  return await cipherOrWrap(kWebCryptoCipherEncrypt, algorithm, key, data, 'encrypt');
}
...
async function decrypt(algorithm, key, data) {
  ...
  return await cipherOrWrap(kWebCryptoCipherDecrypt, algorithm, key, data, 'decrypt');
}
