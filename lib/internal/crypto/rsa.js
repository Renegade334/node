...
function rsaKeyGenerate(algorithm, extractable, keyUsages) {
  try {
    ...
    return PromisePrototypeThen(keyPair, onResolveKeyPair, onRejectKeyPair);

    function onResolveKeyPair(keyPair) {
      const keyAlgorithm = {
        name,
        modulusLength,
        publicExponent,
