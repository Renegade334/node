...
const deprecationMessage = (method) => `channel.${method}(onMessage) is deprecated. ` +
                                       `Use diagnostics_channel.${method}(name, onMessage) instead.`;
...
ObjectDefineProperties(ActiveChannel.prototype,
                       {
                         subscribe: {
                           configurable: true,
                           enumerable: false,
                           writable: true,
                           value: deprecate(ActiveChannel.prototype[kSubscribe],
                                            deprecationMessage('subscribe'),
                                            'DEP0163'),
                         },
                         unsubscribe: {
                           configurable: true,
                           enumerable: false,
                           writable: true,
                           value: deprecate(ActiveChannel.prototype[kUnsubscribe],
                                            deprecationMessage('unsubscribe'),
                                            'DEP0163'),
                         },
                       });
...
ObjectDefineProperties(Channel.prototype,
                       {
                         subscribe: {
                           configurable: true,
                           enumerable: false,
                           writable: true,
                           value: deprecate(Channel.prototype[kSubscribe],
                                            deprecationMessage('subscribe'),
                                            'DEP0163'),
                         },
                         unsubscribe: {
                           ...
                           enumerable: false,
                           writable: true,
                           value: deprecate(Channel.prototype[kUnsubscribe],
                                            deprecationMessage('unsubscribe'),
                                            'DEP0163'),
                         },
                       });
...
function subscribe(name, subscription) {
  return channel(name)[kSubscribe](subscription);
}

function unsubscribe(name, subscription) {
  return channel(name)[kUnsubscribe](subscription);
}
